...
public class GridActorControlInbound__Proxy extends ActorProxyBase<io.vlingo.xoom.lattice.grid.application.GridActorControl.Inbound> implements io.vlingo.xoom.lattice.grid.application.GridActorControl.Inbound, Proxy {
  ...
  private static final String answerRepresentation2 = "answer(io.vlingo.xoom.wire.node.Id, io.vlingo.xoom.wire.node.Id, io.vlingo.xoom.lattice.grid.application.message.Answer<T>)";
  private static final String forwardRepresentation3 = "forward(io.vlingo.xoom.wire.node.Id, io.vlingo.xoom.wire.node.Id, io.vlingo.xoom.lattice.grid.application.message.Message)";
  ...
  private static final String gridDeliverRepresentation5 = "gridDeliver(io.vlingo.xoom.wire.node.Id, io.vlingo.xoom.wire.node.Id, io.vlingo.xoom.actors.Returns<?>, java.lang.Class<T>, io.vlingo.xoom.actors.Address, io.vlingo.xoom.actors.Definition.SerializationProxy, io.vlingo.xoom.common.SerializableConsumer<T>, java.lang.String)";
  private static final String relocateRepresentation6 = "relocate(io.vlingo.xoom.wire.node.Id, io.vlingo.xoom.wire.node.Id, io.vlingo.xoom.actors.Definition.SerializationProxy, io.vlingo.xoom.actors.Address, java.lang.Object, java.util.List<? extends io.vlingo.xoom.actors.Message>)";
  ...
  public <T>void answer(io.vlingo.xoom.wire.node.Id arg0, io.vlingo.xoom.wire.node.Id arg1, io.vlingo.xoom.lattice.grid.application.message.Answer<T> arg2) {
    if (!actor.isStopped()) {
      ...
      if (mailbox.isPreallocated()) { mailbox.send(actor, Inbound.class, consumer, null, answerRepresentation2); }
      else { mailbox.send(new LocalMessage<Inbound>(actor, Inbound.class, consumer, answerRepresentation2)); }
    } else {
      actor.deadLetters().failedDelivery(new DeadLetter(actor, answerRepresentation2));
    }
  }
  ...
  public void forward(io.vlingo.xoom.wire.node.Id arg0, io.vlingo.xoom.wire.node.Id arg1, io.vlingo.xoom.lattice.grid.application.message.Message arg2) {
    if (!actor.isStopped()) {
      ...
      if (mailbox.isPreallocated()) { mailbox.send(actor, Inbound.class, consumer, null, forwardRepresentation3); }
      else { mailbox.send(new LocalMessage<Inbound>(actor, Inbound.class, consumer, forwardRepresentation3)); }
    } else {
      actor.deadLetters().failedDelivery(new DeadLetter(actor, forwardRepresentation3));
    }
  }
  ...
  public <T>void gridDeliver(io.vlingo.xoom.wire.node.Id arg0, io.vlingo.xoom.wire.node.Id arg1, io.vlingo.xoom.actors.Returns<?> arg2, java.lang.Class<T> arg3, io.vlingo.xoom.actors.Address arg4, io.vlingo.xoom.actors.Definition.SerializationProxy arg5, io.vlingo.xoom.common.SerializableConsumer<T> arg6, java.lang.String arg7) {
    if (!actor.isStopped()) {
      ...
      if (mailbox.isPreallocated()) { mailbox.send(actor, Inbound.class, consumer, null, gridDeliverRepresentation5); }
      else { mailbox.send(new LocalMessage<Inbound>(actor, Inbound.class, consumer, gridDeliverRepresentation5)); }
    } else {
      actor.deadLetters().failedDelivery(new DeadLetter(actor, gridDeliverRepresentation5));
    }
  }
  ...
  public void relocate(io.vlingo.xoom.wire.node.Id arg0, io.vlingo.xoom.wire.node.Id arg1, io.vlingo.xoom.actors.Definition.SerializationProxy arg2, io.vlingo.xoom.actors.Address arg3, java.lang.Object arg4, java.util.List<? extends io.vlingo.xoom.actors.Message> arg5) {
    if (!actor.isStopped()) {
      ...
      if (mailbox.isPreallocated()) { mailbox.send(actor, Inbound.class, consumer, null, relocateRepresentation6); }
      else { mailbox.send(new LocalMessage<Inbound>(actor, Inbound.class, consumer, relocateRepresentation6)); }
    } else {
      actor.deadLetters().failedDelivery(new DeadLetter(actor, relocateRepresentation6));
    }
  }
  ...
  public void informNodeIsHealthy(io.vlingo.xoom.wire.node.Id arg0, boolean arg1) {
    if (!actor.isStopped()) {
      ...
      if (mailbox.isPreallocated()) { mailbox.send(actor, Inbound.class, consumer, null, informNodeIsHealthyRepresentation7); }
      else { mailbox.send(new LocalMessage<Inbound>(actor, Inbound.class, consumer, informNodeIsHealthyRepresentation7)); }
    } else {
