 ...
 * @see Parameter
 */
class PropertiesIntrospector extends NopAnnotationIntrospector {
  private static final long serialVersionUID = 1L;

  private final ParameterExtractor parameterExtractor;

  public PropertiesIntrospector(ParameterExtractor parameterExtractor) {
  ...
  public JsonCreator.Mode findCreatorAnnotation(MapperConfig<?> config, Annotated a) {
    ...
    if (ann != null) {
      ...
      if (type.isAnnotationPresent(Properties.class)) {
